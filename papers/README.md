...
| 20 | [ITU and the Standard Model](standard-model/) ✨ | [10.5281/zenodo.20234703](https://doi.org/10.5281/zenodo.20234703) | 135-142 | `standard-model/` | ✅ v1.0.0 |
...
| 20 | Block A #20: Standard Model | 135-142 | ✅ v1.0.0 published |
| 21 | Block A #21: Statistical Mechanics | 143-150 | planned (next) |
...
│   └── *.py, *.png, summary*.json
│
├── standard-model/                     Tier 1 #20: Standard Model ✨ (Phase 135-142)
│   ├── README.md, CITATION.cff, .zenodo.json
│   ├── theory_phase135-142.md
│   └── *.py, *.png, summary*.json
│
└── ...                                 (Block A #21-#25 planned, Phase 143-180)
```
...
```
Terada, M. (2026). ITU and the Standard Model: A Single-Axiom View of
Gauge Symmetry, Higgs Mechanism, QCD, Electroweak Precision, BSM Physics,
and the 2026-2070 Collider Roadmap (v1.0.0).
Zenodo. https://doi.org/10.5281/zenodo.20234703
```
